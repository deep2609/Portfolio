$(function() {
    ...
    $('#contact-form').submit(function(e) {
        ...
        $.ajax({
            url: 'https://formspree.io/f/mwkylznd',
            method: 'POST',
...
window.onload = function(){
     ...
     let names = ['a Competitive Programmer', 'a Full-stack developer','an Avid reader', 'a cricket fanatic']

     execute();

     function execute()
     {
         fulltxt = names[cnt%(names.length)];
         if(isdeleting) 
